...
class Arrest(models.Model):
	...
	Prints_Taken = models.CharField(max_length=3,null=True,blank=True)
	Photos_Taken = models.CharField(max_length=3,null=True,blank=True) 
	...
	Wgt = models.CharField(max_length=5,null=True,blank=True) 
	...
	Charge1_Counts = models.CharField(max_length=4,null=True,blank=True)  
	...
	Charge2_Counts = models.CharField(max_length=4,null=True,blank=True)  
	...
	Charge3_Counts = models.CharField(max_length=4,null=True,blank=True)
	...
	VYR = models.CharField(max_length=5,null=True,blank=True)
